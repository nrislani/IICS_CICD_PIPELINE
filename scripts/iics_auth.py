...
def main():
    ...
    if not (username and password) and not (uat_username and uat_password):
        print("IICS credentials are required. Provide IICS_USERNAME/IICS_PASSWORD and/or UAT_IICS_USERNAME/UAT_IICS_PASSWORD.")
        sys.exit(1)
